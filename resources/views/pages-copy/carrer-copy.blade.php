        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="/" class="navbar-brand "><img src="{{asset('assets/logo/logo_ET.png')}}" style="width:80px; height:80px;" alt=""></a>
                </div>
                <!--/.navbar-header-->
    ...
    <div class="parallax-content-about baner-content-about" id="home">
        <div class="container">
            <div class="text-content">
                <h2><em style="font-size:60px">Carrers </em>
            </div>
        </div>
    </div>
            ...
            <div class="projects-holder">
                <div class="row">
                    <div class="col-md-4 col-sm-6 project-item mix nature">
                        <div class="thumb">
                            <div class="image">
                                <a href="#exampleModalCenter" data-toggle="modal"><img src="{{ asset('assets/img/carrer.png') }}""></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="thumb">
                                        <div class="image">
                                            <a href="" data-lightbox=""><img src="{{ asset('assets/img/carrer.png') }}""></a>
                                            </div>
                                        </div>
                                    </div>
                                            <div class=" col-md-4 col-sm-6 project-item mix branding">
                                                <div class="thumb">
                                                    <div class="image">
                                                        <a href="img/blog_item_02.jpg" data-lightbox="image-1"><img src="{{ asset('assets/img/carrer.png') }}""></a>
                                                 </div>
                                                </div>
                                            </div>
